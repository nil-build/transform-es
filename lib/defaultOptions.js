module.exports = function (options) {
    ...
    if (options.mode === 'production') {
        ...
        options.resolve.alias['process.env.NODE_ENV'] = 'production';
    } else if (options.mode && options.mode !== 'none') {
        options.resolve.alias['process.env.NODE_ENV'] = options.mode;
    }
